...
public class PurchaseSubProcessTest extends SpringActivitiTestCase {
    ...
    public void testAllApproved() throws Exception {
        ...
        ProcessInstance processInstance = formService.submitStartFormData(processDefinition.getId(), properties);//purchase-subprocess:1:4    {amountMoney=22000, listing=1. MacBook Pro一台  2. 27寸显示器一台, dueDate=2013-03-11}
        ...
        formService.submitTaskFormData(task.getId(), properties);//id=16 {deptLeaderApproved=true}
        ...
        formService.submitTaskFormData(task.getId(), properties);//id=23  {planDate=2013-03-20, bankName=中国工商银行, supplier=苹果公司, bankAccount=203840240274247293}

        // 验证是否启动子流程--财务审批    id="treasurerAudit" name="财务审批"
        ...
        System.out.println("////////////applyUser///////////////////"+runtimeService.getVariable(processInstance.getId(), "applyUser")+"////////////////////////////////");
        System.out.println("////////////usage///////////////////"+runtimeService.getVariable(processInstance.getId(), "usage")+"////////////////////////////////");
        System.out.println("////////////amountMoney///////////////////"+runtimeService.getVariable(processInstance.getId(), "amountMoney")+"////////////////////////////////");
        System.out.println("////////////treasurerApproved///////////////////"+runtimeService.getVariable(processInstance.getId(), "treasurerApproved")+"////////////////////////////////");
        assertEquals(listing, runtimeService.getVariable(processInstance.getId(), "usage"));//这个id对应的usage（用途）的值
