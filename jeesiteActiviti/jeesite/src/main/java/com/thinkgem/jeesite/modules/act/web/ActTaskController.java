...
public class ActTaskController extends BaseController {
    ...
    public Map<String, List<String>> readStartableData(@PathVariable("processDefinitionId") String processDefinitionId) {
        ...
        datas.put("users_", users);
        datas.put("groups_", groups);
        return datas;
    }	
...
///////////////////////////////////////旧有方法//////////////////////////////////////////////////////////////////////////	    page = actTaskService.processList(page, category);
	    ...
	    if (StringUtils.isNotEmpty(category))processDefinitionQuery.processDefinitionCategory(category);
...
//        model.addAttribute("linksMap", linksMap);
    ...
    private Map<String, Map<String, List<? extends Object>>> setCandidateUserAndGroups(List<ProcessDefinition> processDefinitionList) {
        ...
        for (ProcessDefinition processDefinition : processDefinitionList) {
            ...
            List<Role> linkGroups = new ArrayList<Role>();
