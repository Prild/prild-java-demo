...
import com.thinkgem.jeesite.modules.act.utils.ActivityUtil;
...
public class TraceProcessController extends BaseController{
    ...
    public ModelAndView historyDatas(@PathVariable("executionId") String executionId) {
        ModelAndView mav = new ModelAndView("chapter6/trace-process");
...
//            User assigneeUser = identityService.createUserQuery().userId(assignee).singleResult();
        	User assigneeUser =systemService.getUserByLoginName(assignee);
            String userInfo = assigneeUser.getName() + " " + "/" + assigneeUser.getLoginName();
