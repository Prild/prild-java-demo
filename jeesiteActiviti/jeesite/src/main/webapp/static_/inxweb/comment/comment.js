...
function queryCommentReply(pCommentId) {
	$.ajax({
		url : ctx_ + '/web/comment/ajax/commentreply',
		data : {
			"comment.otherId" : otherId,
			"comment.pCommentId" : pCommentId
		},
		type : 'post',
		async : true,
		dataType : 'text',
...
function addCommentReply(commentId) {
	...
	$.ajax({
		url : ctx_ + '/web/comment/ajax/addcomment',
		type : 'post',
		data : {
			"comment.pCommentId" : commentId,
...
function queryCommentReplyPage(pCommentId) {
	...
	$.ajax({
		url : ctx_ + '/web/comment/ajax/commentreplypage',
		data : {
			"comment.otherId" : otherId,
			"comment.pCommentId" : pCommentId
		},
