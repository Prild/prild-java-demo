...
function addComment(obj){
	if(isLogin()){
		...
		$.ajax({
			url:ctx_ + "/questionscomment/ajax/add",
			data:{
...
function addReply(obj){
	if(isLogin()){
		...
		$.ajax({
			url:ctx_ + "/questionscomment/ajax/addReply",
			data:{
...
function acceptComment(commentId){
	$.ajax({
		url:ctx_ + "/questionscomment/ajax/acceptComment",
		data:{
			"questionsComment.commentId":commentId,
			"questionsComment.questionId":questionsId
		},
...
function getCommentById(obj,commentId){
	$.ajax({
		url:ctx_ + "/questionscomment/ajax/getCommentById/"+commentId,
		data:{
...
function getAllCommentById(pCommentId) {
	...
	$.ajax({
		url : ctx_ + '/questionscommentall/ajax/getCommentById/'+pCommentId,
		data : {
		},
		type : 'post',
		async : true,
