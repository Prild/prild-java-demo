		...
		<ul class="pr10">
				<li>
					...
					<div class="of mt5">
						...
						</font></span> <span class="fl"> <a href="javascript: void(0)" title="回答" class="noter-dy vam" onclick="getCommentById(this,${questionsComment.id_ })">${questionsComment.id_ }
								<em class="icon18">&nbsp;</em>(<span>${questionsComment.replyCount }</span>)
							</a> <tt class="noter-zan vam ml10" title="赞一下" onclick="addPraise(${questionsComment.id_ },2,this)">${questionsComment.id_ }questionscomment-ajax-listreply_all.jsp
									...
									<dd>
										<aside class="n-reply-pic">
												<c:choose>
													...
													<c:otherwise>
														<img src="${ctx_s }/static_/inxweb/img/avatar-boy.gif" alt="">
													</c:otherwise>
												</c:choose>
										</aside>
										<div class="of">
										...
										<div class="of mt5">
											...
											<span class="fl">
												<tt class="noter-zan vam" title="赞一下" onclick="addPraise(${questionsComment.id_ },2,this)"><em class="icon18">&nbsp;</em>(<span>${questionsComment.praiseCount }</span>)</tt>
											</span>
										</div>
									</dd>
								</c:forEach>
