...
<%--<script src="${ctxStatic_ }/inxweb/front/courseInfo.js"></script> --%>
...
<body>
	<div id="aCoursesList" class="bg-fa of">
		...
		<section class="container">
			<section class="path-wrap txtOf hLh30">
				...
				\
				<a href="${ctx_ }/front/showcoulist" title="" class="c-999 fsize14">课程列表</a>
				...
				<article class="c-v-pic-wrap">
					<section class="p-h-video-box" id="videoPlay">
						<c:choose>
							...
							<c:otherwise>
								<img src="${ctx_s}/static_/inxweb/img/default-img.gif" alt="${course.courseName}" class="dis c-v-pic" />
							</c:otherwise>
						</c:choose>
					...
					<section class="p-h-video-tip">
						<img src="${ctx_s}/static_/inxweb/img/v-loading.gif">
											...
											<div class="u-face">
												<a href="${ctx }/front/teacher/${tea.id }">
													<c:choose>
														...
														<c:otherwise>
															<img src="${ctx_s }/static_/inxweb/img/avatar-boy.gif" width="50" height="50" alt="">
														</c:otherwise>
													</c:choose>
												</a>
											</div>
											<section class="hLh30 txtOf">
												<a class="c-333 fsize16 fl" href="${ctx_ }/front/teacher/${tea.id }">${tea.name }</a>
											</section>
										...
										<c:forEach items="${courseList}" var="interfixCourse">
											<li>
												<aside class="course-r-pic">
													<a href="${ctx_ }/front/couinfo/${interfixCourse.courseId}" title="">
														<c:choose>
															<c:when test="${interfixCourse.logo!=null && interfixCourse.logo!=''}">
																<img alt="" src="<%=staticImage%>${interfixCourse.logo}" />
															</c:when>
															<c:otherwise>
																<img alt="" src="${ctx_s }/static_/inxweb/img/default-img.gif" />
															</c:otherwise>
														</c:choose>
													</a>
												</aside>
												<section class="hLh20 txtOf">
													<a href="${ctx_ }/front/couinfo/${interfixCourse.courseId}" class="c-333 fsize16">${interfixCourse.courseName}</a>
												</section>
	...
	<script type="text/javascript" src="${ctx_s}/static_/inxweb/front/courseInfo.js"></script>
	<script type="text/javascript" src="${ctx_s}/static_/inxweb/comment/comment.js"></script>
	<script>
		//评论课程id
