...
<script src="${ctx_s }/static_/inxweb/comment/comment.js" type="text/javascript"></script>
				...
				<div class="fl col-7">
					<section class="mr30">
						<section class="path-wrap txtOf hLh30">
							...
							\
							<a href="${ctx_}/front/articlelist" title="" class="c-999 fsize14">文章列表</a>
						...
						<article class="article-infor-box pr20">
							...
							<section class="mt20 tac" id="sharebutton">
								<div class="bdsharebuttonbox clearfix disIb">
									...
									<!-- <a title="分享到QQ空间"  href="#" class="bds_qzone fl" data-cmd="qzone"></a> -->
								</div>
