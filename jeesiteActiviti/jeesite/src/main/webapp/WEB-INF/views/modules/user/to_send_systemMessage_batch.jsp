...
KindEditor.ready(function(K) {
	...
	function sendmessage(){
		...
		if(content==null||content.trim()==""){
		 ...
		 $.ajax({
             url:"${ctx}/studentuser/letter/sendJoinGroupBatch",
             type:"post",
             data:{
            	 "content":content,
		...
		<form action="${ctx}/admin/cou/addCourse" method="post" id="saveCourseForm">
			...
			<table style="line-height: 35px;">
				<tr>
					...
					<td>
						<textarea name="" id="userEmails" name="userEmails"  style="width: 641px; height: 76px;"></textarea><br />
				...
				<tr>
					<td colspan="2" align="center">
						<input onclick="sendmessage()" class="btn btn-small" type="button" value="保存" />
