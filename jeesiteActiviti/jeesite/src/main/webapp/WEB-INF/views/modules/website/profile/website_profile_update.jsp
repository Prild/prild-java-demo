			...
			<div class="mt20">
				...
				<c:if test="${type=='inxeduVideo'}">
					...
					<p>
						...
						<input type="text" name="UserId" value="${webSiteMap.emailConfigure.SMTP}" style="width: 15%" class="sf" />
						<span class="field_desc"></span>
					</p>
					<p>
						<label ><font color="red">*</font>&nbsp;邮件账号</label>
						<input type="text" name="SecretKey" value="${webSiteMap.emailConfigure.username}" style="width: 15%" class="sf" />
						<span class="field_desc"></span>
					</p>
					<p>
						<label ><font color="red">*</font>&nbsp;邮件密码</label>
						<input type="text" name="AccessKey" value="${webSiteMap.emailConfigure.password}" style="width: 15%" class="sf" />
						<span class="field_desc"></span>
					</p>
				</c:if>
				<p>
