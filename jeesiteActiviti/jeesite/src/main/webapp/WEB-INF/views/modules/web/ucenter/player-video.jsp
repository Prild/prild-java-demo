...
<body>
	...
	<script type="text/javascript" src="${ctx_s}/static_/common/jquery-1.11.1.min.js"></script>
	...
	<script type="text/javascript" src="${ctx_s}/static_/inxweb/comment/comment.js" ></script><!-- 评论js -->
	<script type="text/javascript" src="${ctx_s}/kindeditor/kindeditor-all.js"></script>
	<script type="text/javascript" src="${ctx_s}/static_/inxweb/play/playVideo.js"></script>
