...
<script type="text/javascript">
	...
	function batchDelFav() {
		...
		dialog("删除提示", "确认要删除选择的收藏课程？", 2, "${ctx_}/uc/deleteFaveorite/"
				+ favouriteIdStr);
	}
</script>
</head>
											...
											<section class="mt10">
												<div class="of cancel-colle">
													<div class="fr tac">
														...
														<a href="${ctx_}/uc/deleteFaveorite/${favorite.favouriteId}" title="" class="c-blue">取消收藏</a>
													</div>
													<a href="${ctx_ }/front/couinfo/${favorite.courseId }" title="">
														<c:choose>
												...
												<div class="hLh30 txtOf">
													<a href="${ctx_ }/front/couinfo/${favorite.courseId }" class="c-666 fsize14">${favorite.courseName }</a>
												</div>
											</section>
										</dd>
									</dl>
