...
<body>
					...
					<section class="mr30">
						...
						<div class="q-c-list">
							...
							<dl>
								...
								<dd class="pr">
									<label class=""><input type="text" style="width: 80px;" name="randomCode" placeholder="输入验证码" value="" onkeyup='$(this).parent().next().next().html("<img width=\"16\" height=\"16\" alt=\"正确\" src=\"${ctx_s }/static_/inxweb/img/d-icon.png\">")'></label>
									<div class="v-code-pic">
										<img src="${ctx_}/ran/random" alt="验证码，点击图片更换" onclick="this.src='${ctx_}/ran/random?random='+Math.random();" width="80" height="34" class="vam">
				...
				<aside class="fl col-3">
					<div class="mt30 pl10">
						<section class="q-tip-pic col-3">
							<img src="${ctx_s }/static_/inxweb/img/tipQe.png" width="100%" alt="亲，您要提问吧？">
						</section>
						<h5 class="pt10">
	...
	<script type="text/javascript" src="${ctx_s}/static_/inxweb/questions/questions_add.js"></script>
</body>
</html>