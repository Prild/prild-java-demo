...
<body>
				...
				<div class="fl col-7">
					<section class="mr30 pt10">
						<section class="path-wrap txtOf hLh30">
							...
							\
							<a href="${ctx_ }/questions/list" title="" class="c-999 fsize14">全部问答</a>
										...
										<div class="mt20 pr10">
											<section class="fr">
												<span> <a href="#i-art-comment" title="评论" class="noter-dy vam">
													...
													</a> <tt class="noter-zan vam ml10 f-fM" title="赞一下" onclick="addPraise(${questions.id_ },1,this)">
											...
											<section class="fl ml20 pt10">
												<div class="taglist clearfix">
													<c:forEach items="${questionsTagRelationList }" var="questionsTag">
	...
	<script>
	var questionsId="${questions.id_}";
	</script>
	<script type="text/javascript" src="${ctx_s}/static_/inxweb/questions/questions_info.js"></script>
