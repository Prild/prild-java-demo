...
<body>
	<div class="pad20">
		<form action="${ctx}/website/updateWebsiteCourse" method="post" id="updateWebsiteCourseForm">
			<input type="hidden" name="websiteCourse.id_" value="${websiteCourse.id_}" />
			<fieldset>
				...
				<p>
					<input type="button" value="提交" class="btn btn-primary btn-sm" onclick="updateSubmit()" />
					<input type="button" value="返回" class="btn  btn-sm" onclick="javascript:history.go(-1);" />
				</p>
			</fieldset>
		</form>
	</div>
