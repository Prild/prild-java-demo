...
<body>
			...
			<section class="i-article">
				<div class="fl col-7">
					<section class="mr30">
									...
									<c:forEach var="article" items="${articleList }">
										<li>
											<aside class="i-article-pic">
												<img xSrc="<%=staticImage%>${article.imageUrl }" src="${ctx_ }/static/inxweb/img/default-img.gif" alt="${article.title }">
											</aside> <!-- ${ctx }/web/article/showInfor/${article.articleId } -->
											<h3 class="hLh30 txtOf">
												<a href="${ctx_ }/front/articleinfo/${article.articleId}.html" title="${article.title }" class="i-art-title">${article.title }</a>
											</h3>
											...
											<section class="hLh30 txtOf mt5 pr10 a-list-extrainfo">
												...
												<div class="fl">
													<span> <a class="noter-dy vam" title="回答" href="${ctx_ }/front/articleinfo/${article.articleId}.html">
						...
						<!-- 公共分页 开始 -->
						<form action="${ctx_ }/front/articlelist" method="post" id="searchForm">
	...
	<script src="${ctx_s }/static_/inxweb/acticle/acticle.js" type="text/javascript"></script>
	<script>
		$(function() {
