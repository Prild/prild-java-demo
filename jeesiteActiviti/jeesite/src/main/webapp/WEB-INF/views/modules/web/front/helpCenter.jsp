	...
	<div id="aCoursesList" class="bg-fa of">
		<div class="container">
			<section class="path-wrap txtOf hLh30"> 
				<a class="c-999 fsize14" title="" href="http://127.0.0.1:38080">首页</a>
				...
				<div class="fl h-left">
					...
					<ul class="h-l-nav">
						<c:forEach items="${helpMenus}" var="helpMenu" varStatus="index">
							<li>
								<c:if test="${helpMenu.size()==1}"><!-- 父菜单，无子 添加超链接，点击之后显示的数据库里面的内容 -->
									<a href="
								...
								<c:if test="${helpMenu.size()>1}"><!-- 父菜单，有子 给子添加超链接 点击之后跳转到外部页面？-->
