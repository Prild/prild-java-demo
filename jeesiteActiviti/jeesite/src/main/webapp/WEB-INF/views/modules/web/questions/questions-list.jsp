...
<body> 
				...
				<div class="fl col-7">
					<section class="mr30 pt10">
						...
						<div class="q-list">
										...
										<c:forEach items="${questionsList }" var="question">
											<li>
												...
												<section class="q-txt-box">
													<a class="replyBrowseNum" href="${ctx_ }/questions/info/${question.id_ }" title="">
														<div class="replyNum">
													...
													<h3 class="hLh30 txtOf">
														...
														<a href="${ctx_ }/questions/info/${question.id_ }" title="" class="fsize16 c-333 vam">${question.title }</a>
													</h3>
							...
							<!-- 公共分页 结束 -->
							<form action="${ctx_}/questions/list" id="searchForm" method="post">
	...
	<script type="text/javascript" src="${ctx_s}/static_/inxweb/questions/questions.js"></script>
</body>
</html>