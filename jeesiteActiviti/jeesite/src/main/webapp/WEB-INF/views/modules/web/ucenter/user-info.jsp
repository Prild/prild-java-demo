...
<title>我的资料</title>
<link rel="stylesheet" type="text/css" href="${ctx_s}/static_/common/jcrop/jquery.Jcrop.min.css" />
...
<body>
	...
	<!-- /右侧内容区 结束 -->
<script type="text/javascript" src="${ctx_s}/static_/common/jcrop/jquery.Jcrop.min.js"></script>
<script type="text/javascript" src="${ctx_s}/static_/inxweb/user/user.js"></script>
