...
function updQuestions(){
	var id_=$("#updateForm input[name='questions.id_']").val();
	...
	$.ajax({
		url:ctx +"/questions/updQuestions",
		data:{
			"questions.id_":id_,
...
<body>
	<div class="pad20" style="background-color: #f0f0f0;">
		<form action="${ctx}/questions/updQuestions" method="post" id="updateForm">
			<table class="table table-striped">
				<tr>
					...
					<td>
						<input id="" name="questions.id_" value="${questions.id_}" type="hidden"/>
				...
				<tr>
					<td>问答内容:</td>
					<td style="text-align: left;">
						<textarea name="questions.content" style="margin: 0px; width: 476px; height: 113px;">${questions.content}</textarea>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td colspan="2" align="center">
						<input onclick="updQuestions()" class="btn btn-sm" type="button" value="修改" />
