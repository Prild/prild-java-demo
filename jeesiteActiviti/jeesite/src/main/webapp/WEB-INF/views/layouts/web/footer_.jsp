		...
		<div class="b-foot">
			<section class="fl col-7">
				<section class="mr20">
					...
					<%--<span>服务热线：${websitemap.web}</span> <span>Email：${websitemap.web }</span> --%>	
					</section>
					<section class="b-f-link mt10">
					<%--	<span>${websitemap.web }</span> --%>
					</section>
				</section>
			</section>
			<aside class="fl col-3 tac mt15">
				<section class="gf-tx">
					<span><img src="${ctx_s}/static_/inxweb/img/wx-icon.png" alt=""></span>
					<div class="gf-tx-ewm">
				...
				<section class="gf-tx">
					<span><img src="${ctx_s}/static_/inxweb/img/wb-icon.png" alt=""></span>
					<div class="gf-tx-ewm">
					<c:forEach var="image" items="${websiteImages.type_11}" varStatus="status">
