...
<table width="100%" class="table table-bordered table-hover table-condensed">
    ...
    <c:forEach items="${page.result }" var="pd">
        <tr>
            ...
            <td><a target="_blank" title="${pd.diagramResourceName }" href='${ctx }/act/process3/read-resource?pdid=${pd.id }&resourceName=${pd.diagramResourceName }'>单击查看</a></td>
            <td>
            ...
            <!-- <a class="btn btn-small" href='${ctx }/chapter6/getform/start/${pd.id }'><i class="icon-play"></i>启动</a> -->
                <a class="btn btn-small" href='${ctx }/act/process2/getform/start/${pd.id }'><i class="icon-play"></i>启动</a>
            </td>
        </tr>
