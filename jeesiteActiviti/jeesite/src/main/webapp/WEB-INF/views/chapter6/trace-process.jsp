...
<link rel="stylesheet" href="${ctxCss}/css/style.css" type="text/css"/>
   ...
   <script type="text/javascript" src="${ctxCss}/common/jquery.js"></script>
    ...
    <script type="text/javascript" src="${ctxCss}/common/chapter12/trace-process.js"></script>
</head>
<body>${activeActivities}
    <%-- 先读取图片再通过Javascript定位 --%>
    <div>
        <img id="processDiagram" src="${ctx }/act/read-resource?pdid=${historicProcessInstance.processDefinitionId}&resourceName=${processDefinition.diagramResourceName}" />
    </div>
