...
public class LeaveDynamicFormTest extends AbstractTest {
    ...
    public void testJavascriptFormType() throws Exception {
        ...
        ProcessDefinition processDefinition = repositoryService.createProcessDefinitionQuery().processDefinitionKey("leave").singleResult();//如果没有实体匹配查询条件，则执行查询并返回结果实体或null。
        
        StartFormData startFormData = formService.getStartFormData(processDefinition.getId());//流程定义ID：leave:1:96 通过流程定义ID获取表单字段集合
        List<FormProperty> formProperties = startFormData.getFormProperties();
        for (FormProperty formProperty : formProperties) {
            System.out.println("////////////////////////////////////////////////id="+formProperty.getId() + "，value=" + formProperty.getValue()+"////////////////////////////////////////////////");
        }
    }
    ...
    public void allApproved() throws Exception {
        ...
        identityService.setAuthenticatedUserId(currentUserId);	//同一线程所执行的所有服务 都可以访问这个authenticatedUserId
        ...
        System.out.println("////////////////////////////hrTask.getId():"+hrTask.getId());
